        ...
        var methods = {
            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    var newTableWidth  = tableWidth - scrollBarWidth;
                  ...
                  //Si existe el tfoot lo duplica, sino no muestra nada, basicamente es lo mismo que
                    ...
                    if (element.find('tfoot').length > 0) {                        
                        ...
                        var fixedFooter = $('<div class="fixedFooter"><table><tfoot></tfoot></table></div>');
                        ...
                        element.find('tfoot tr td').each(function (i) {                           
                            ...
                            fixedFooter.find('table tfoot tr').append(td);
                  ...
                  //Si existe el thead lo duplica sino no muestra nada.
                    if (element.find('thead').length > 0) {
                        ...
                        //var fixedHeader = $('<style>td{border: 1px solid black !important}</style><div class="fixedHeader"><table><thead><tr></tr></thead></div>');
