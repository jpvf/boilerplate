  ...
  $.fn.qtSelect = function (method) {
    ...
    var methods = {
      init: function (options) {
        ...
        return this.each(function () {
			...
			var finalHtml = helpers._createSelect(selected.html(), options);			
			...
			element.find('.options div').eq(selected.index()).attr('id','current').addClass('ui-state-active');
	...
	var events = {		
		...
		_setAll : function(element, select){
			...
			//element.live('click', function(e){ e.stopPropagation();});
		...
		_toggleDisplayState : function(){
			...
			var element = $(this);
			var options = element.closest('.qtSelect').find('.options');
