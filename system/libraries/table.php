...
class Table
{
    ...
    private function _create_row($data, $attr, $tag = 'tr')
    {
        $row = '';
	...
	public function add_heading($data = array(), $attr = array())
	{
	    $this->table_head[] = $this->_create_row($data, $attr, $this->headings_tag);		
		return $this;
	}
